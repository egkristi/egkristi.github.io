# egkristi.github.io — Licensing

egkristi.github.io uses a **dual-license model**: open source for the community,
...
egkristi.github.io is licensed under the
[GNU Affero General Public License v3.0](LICENSES/AGPLv3.txt) (AGPLv3).

This covers:
- All web page source code and assets
...
1. Use egkristi.github.io commercially with **>50 users** and **>$5M revenue/year**
2. Distribute egkristi.github.io inside a product **without** releasing your source under AGPLv3
3. Offer egkristi.github.io as a **hosted/managed service** without releasing modifications
...
**The SaaS loophole:** MIT and Apache 2.0 allow cloud providers to offer egkristi.github.io
...
Open an issue: https://github.com/egkristi/egkristi.github.io/issues
